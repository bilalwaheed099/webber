        ...
        <div>
            <div className="h-screen bg-gradient">
                ...
                <div className="flex justify-between stretch">
                    ...
                    <section className="w-4/12">
                        ...
                        <div className="gradient w-full h-80 mt-20 flex flex-col justify-evenly p-8">
                            ...
                            <div className="mt-4">
                                <button className="rounded-sm bg-white w-32 h-12 blue-text">Start trial</button>
                                <button className="ml-4 border-solid border border-white bg-transparent rounded-sm w-36 h-12 text-white">Contact sales</button>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div className="bg-gray-100 mt-16 py-16 border-b border-gray-300 border-solid">
                    <h1 className="text-3xl  stretch font-bold">More case studies</h1>
                    <section className="grid grid-cols-4 gap-12  stretch mt-16">
                        <CaseStudyCard 
