        ...
        <div>
            <div className="h-screen bg-gradient">
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    {/* Buttons */}
                    <div className="flex w-1/4 mt-12 justify-evenly">
                        <button className="w-36 h-12 gradient-rot text-white">Get Started</button>
                        <button className="w-36 h-12 light-blue text-blue-500">Learn More</button>
                    </div>
                </div>
            </div>
                ...
                <div className="relative -mt-20 gradient-rot2 w-full h-56 flex justify-center stretch "></div>
                    {/* Browser frame */}
                <img className="relative mx-auto -mt-32 object-contain" src="https://user-images.githubusercontent.com/57569861/125332027-2c08b380-e362-11eb-91ee-8e40180ceda4.png"/>

                
            {/* Features */}
            <div className="mt-48 h-screen">
                <SecHeading text="Tailor-made features"/>
                <div className="grid grid-cols-3 grid-rows-2 gap-8 w-5/6 mx-auto mt-20">
            ...
            {/* How it works */}
            <div className="lg:mt-4 sm:mt-64">
                <SecHeading text="How it works"/>
                <section className="flex lg:flex-row lg:items-center lg:justify-evenly mt-12 sm:flex-col sm:items-center ">
                    {/* Left */}
                    <div className="flex flex-col justify-center ">
                        <h1 className="font-extrabold text-5xl pri-gray">Sign Up</h1>
                        <p className="mt-8 text-xl gray-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Erat <br/>
                    ...
                    {/* Right */}
                    <div>
                    <img className="object-contain relative left-8" src="https://user-images.githubusercontent.com/57569861/125330992-dc75b800-e360-11eb-9f1e-fa3c6ed2631b.png"></img>
                    </div>
                </section>
            </div>

            {/* Blue Banner */}
            <section className="gradient w-full h-64 mt-28 flex justify-evenly items-end py-16">
                {/* left */}
                ...
                <div className="flex">
                    ...
                    <p className="text-white font-medium text-lg ml-4 leading-8">Eos enim quo est necessitatibus nobis consectetur rerum qui dolores. Quia commodi similique <br/> 
            ...
            <div className="mt-48 h-screen">
                ...
                <section className="grid 2xl:grid-cols-4 2xl:grid-rows-2 mt-20 gap-6 w-1/2 mx-auto lg:grid-cols-3 lg:grid-rows-3 md:grid-rows-4 md: grid-cols-2">
            ...
            {/* By the numbers */}
            <section className="gradient w-full h-84 flex flex-col justify-evenly items-center">
            <h1 className="text-white mx-auto w-100 text-center font-black text-6xl relative top-14">By the numbers</h1>
                <p className="text-white mt-4 relative top-20">5 years, consistent quality and you get results. No matter what</p>
                <div className="grid grid-cols-4 grid-rows-1 gap-6 mt-8 relative top-28">
            ...
            <section className="flex flex-col justify-evenly items-center mb-32">
                <h1 className="text-5xl font-black w-1/2 mt-60 text-center pri-gray">Build the next big thing and ship to market faster </h1>
